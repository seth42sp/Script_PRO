...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/seth42sp/Script_PRO/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/seth42sp/Script_PRO/main/badvpn/antcrashvpn.sh -o /dev/null
